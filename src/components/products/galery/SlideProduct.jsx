  ...
  return (
    <section {...props}>
      ...
      <div className="col-span-4 relative">
        <img src={ARRAY_IMGS[indexImg]} alt="" className="object-cover aspect-[16/13] w-full md:aspect-[16/18] rounded-md md:cursor-pointer xl:aspect-[16/16] 2xl:max-h-[600px]" onClick={handleOpenModal} />
