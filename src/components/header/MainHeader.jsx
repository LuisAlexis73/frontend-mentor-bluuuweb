...
const MainHeader = () => {
  ...
  const handleOpenMenu = () => {
    setNavclass('absolute top-0 left-0 flex h-full gap-y-5 p-8 flex-col md:mr-auto md:flex md:flex-row md:gap-4 font-bold bg-white w-4/5 md:static md:p-0 md:h-auto z-10');
  };
